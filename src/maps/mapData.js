...
export var neighborhoodInfo = {
    hampden: {
        name: "Hampden",
        tag: "Suggested Airbnb neighborhood",
        coordinates: [39.330, -76.632],
        color: "gold",
        fillColor: "gold",
        fillOpacity: 0.5,
        radius: 700
    ...
    mtvernon: {
        name: "Mt Vernon and Midtown",
        tag: "Suggested Airbnb neighborhood",
        coordinates: [39.305, -76.619],
        color: "gold",
        fillColor: "gold",
        fillOpacity: 0.5,
        radius: 700
